...
class Main:
	def __init__(self):
      ...
      |__/     |__/       \______/        \______/                                                                                                                                            
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mCREATED BY  :AB KHANX
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK    :AB KHANX
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mYOUTUBE     :MSS TRICKS
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mJIGERS        :ARMAN X3 SALMANO 
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sM S S "%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION      : %s2.0"%(G,R,G,B,G))
		print("%s [%s•%s] %sSTATUS       : %s"%(G,R,G,B,stat)) 
		print("")
		print("%s [%s01%s]%s CRACK RANDOM FB ID 2009-11 
		print("%s [%s02%s]%s CRACK RANDOM FB ID 2005-8
		print("%s [%s03%s]%s CRACK RANDOM FB ID 2004-5
		print("%s [%s04%s]%s CRACK FROM EMAILS FB ID 
		print(GET)
		hoga = input("\n%s [?] CHOICE : "%(B))
		if hoga in ["", " "]:
			Main()
